...
int main(int argc, char **argv)
{
    ...
    for(int i = 0; i < numHouses; i++) //Create the X Matrix used for the test values
    {
        for(int j = 1; j < numCols; j++)
        {
    ...
    //Series of steps to get to the final answer, variable names are self explanatory.
    //Memory is freed as soon as it is no longer needed in order to prevent overflow errors
